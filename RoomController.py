...
class RoomController:
    ...
    def __init__(self):
        ...
        # do the handling
        self._button = Button(1, "button1", buttonhandler=None)
        self._partybutton = Button (2, "partybutton", buttonhandler=None)
        self._timer = SoftwareTimer(None)
        
        self._light = Light(7,"RoomLight")
        R=DimLight(10," red")
        G=DimLight(11, "green")
        B= DimLight(12, "blue")
        self._partylight= Pixel(R,G,B)
        self._sensor = AnalogSensor(28, lowactive=True, threshold= 40000)
